...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 07, 2016 at 07:49 PM
...
select c.FName ,c.Lname from delivery d inner JOIN customers c on d.IsActive=deliverystatus and d.CustomerID=c.CustomerID;
END$$
...
(30, 'jj', 'jj', 'jj', '666-5566778', 6),
(31, 'uh', 'vj', 'gh', '555-5544887', 8);
...
('aaa', '123456', 'aaa', 'aaa', 'ggg', '963-8527415', 1),
